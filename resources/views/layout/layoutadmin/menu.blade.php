            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="{!! route("superuser.produk.index") !!}"><i class="fa fa-th"></i> Produk </span></a>
                  ...
                  <li><a href="{!! route("superuser.pemesanan.index") !!}"><i class="fa fa-list"></i> Data Pemesanan </span></a>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src={!! asset("assetadmin/images/img.jpg") !!} alt="">{{Auth::user()->name}}
